...
CREATE INDEX idx_vinculos_usuario ON vinculos (id_usuario);
CREATE INDEX idx_vinculos_tipo_status ON vinculos (id_estabelecimento, tipo, status);
...
CREATE INDEX idx_clientes_tenant_vinculo ON clientes (id_estabelecimento, id_vinculo);
...
CREATE INDEX idx_profissionais_tenant_vinculo ON profissionais (id_estabelecimento, id_vinculo);
...
CREATE INDEX idx_administradores_tenant_vinculo ON administradores (id_estabelecimento, id_vinculo);
...
CREATE INDEX idx_sessoes_lembradas_vinculo ON sessoes_lembradas (id_vinculo);
